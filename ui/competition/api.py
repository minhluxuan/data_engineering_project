...
class EventResultOperation:
    ...
    def search(edition_id, country_noc, result_id, athlete_id):
        url = f"{EventResultOperation.base_url}{edition_id}-{country_noc}-{result_id}-{athlete_id}/"
    ...
    def update(edition_id, country_noc, result_id, athlete_id, data):
        ...
        url = f"{EventResultOperation.base_url}u/{edition_id}-{country_noc}-{result_id}-{athlete_id}/"
